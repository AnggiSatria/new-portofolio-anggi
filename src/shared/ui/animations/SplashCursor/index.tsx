...
//         : (halfFloat as OES_texture_half_float)?.HALF_FLOAT_OES || 0;
//       let formatRGBA: GLenum | undefined;
//       let formatRG: GLenum | undefined;
//       let formatR: GLenum | undefined;

//       // Membuat fungsi dengan tipe yang benar
//       const getFormat = (
...
//         type: GLenum
//       ): GLenum | undefined => {
//         const result = getSupportedFormat(gl, internalFormat, format, type);
//         return result ? result.internalFormat : undefined; // Hindari null
//       };

//       if (isWebGL2) {
//         formatRGBA = getFormat(
